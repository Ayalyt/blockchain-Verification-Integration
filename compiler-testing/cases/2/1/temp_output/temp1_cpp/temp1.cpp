...
// load src
Fr_add(&expaux[4],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 2]); // line circom 134
Fr_mul(&expaux[2],&circuitConstants[52],&expaux[4]); // line circom 134
Fr_sub(&expaux[1],&expaux[2],&signalValues[mySignalStart + 6]); // line circom 134
Fr_sub(&expaux[0],&expaux[1],&signalValues[mySignalStart + 5]); // line circom 134
// end load src
