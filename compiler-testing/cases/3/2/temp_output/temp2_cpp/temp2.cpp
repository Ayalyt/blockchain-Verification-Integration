...
#include "circom.hpp"
#include "calcwit.hpp"
void MWSjpAALvcBE_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MWSjpAALvcBE_0_run(uint ctx_index,Circom_CalcWit* ctx);
void O3h4P1AWedYt_1_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void O3h4P1AWedYt_1_run(uint ctx_index,Circom_CalcWit* ctx);
void hA3Ked4lxIcti7O_0(Circom_CalcWit* ctx,FrElement* lvar,uint componentFather,FrElement* destination,int destination_size);
void ZySYRmHRP5ZTtmW_1(Circom_CalcWit* ctx,FrElement* lvar,uint componentFather,FrElement* destination,int destination_size);
...
FrElement expaux[1];
std::string myTemplateName = "hA3Ked4lxIcti7O";
u64 myId = componentFather;
// return bucket
Fr_copy(destination,&lvar[9]);
return;
}
...
FrElement* circuitConstants = ctx->circuitConstants;
FrElement expaux[7];
std::string myTemplateName = "ZySYRmHRP5ZTtmW";
u64 myId = componentFather;
Fr_div(&expaux[2],&circuitConstants[13],&circuitConstants[17]); // line circom 9
Fr_sub(&expaux[3],&circuitConstants[12],&circuitConstants[17]); // line circom 9
Fr_bxor(&expaux[1],&expaux[2],&expaux[3]); // line circom 9
Fr_bxor(&expaux[3],&circuitConstants[13],&circuitConstants[13]); // line circom 9
Fr_bxor(&expaux[4],&circuitConstants[13],&circuitConstants[12]); // line circom 9
Fr_bxor(&expaux[2],&expaux[3],&expaux[4]); // line circom 9
Fr_add(&expaux[0],&expaux[1],&expaux[2]); // line circom 9
if(Fr_isTrue(&expaux[0])){

}
// return bucket
Fr_copy(destination,&lvar[16]);
return;
}
...
ctx->componentMemory[coffset].templateName = "MWSjpAALvcBE";
...
// load src
Fr_mul(&expaux[1],&circuitConstants[19],&signalValues[mySignalStart + 4]); // line circom 94
Fr_sub(&expaux[0],&expaux[1],&signalValues[mySignalStart + 3]); // line circom 94
// end load src
...
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 4]); // line circom 95
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 6]); // line circom 95
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 5]); // line circom 95
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 0],&signalValues[mySignalStart + 4]); // line circom 96
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 0; i++){
...
ctx->componentMemory[coffset].templateName = "O3h4P1AWedYt";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "ASjLBk8vHA4s";
MWSjpAALvcBE_0_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[58]);
}
{
PFrElement aux_dest = &lvar[70];
// load src
// end load src
Fr_copy(aux_dest,&lvar[59]);
}
{

// start of call bucket
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[47],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[51],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[56],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[71],1);
// end call bucket
}
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[60],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[64],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[69],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[72],1);
// end call bucket
}
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[73]);
}
{
PFrElement aux_dest = &lvar[85];
// load src
// end load src
Fr_copy(aux_dest,&lvar[74]);
}
{
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[75],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[79],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[84],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[86],1);
// end call bucket
}
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[87]);
}
{
PFrElement aux_dest = &lvar[99];
// load src
// end load src
Fr_copy(aux_dest,&lvar[88]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[100]);
}
{
PFrElement aux_dest = &lvar[112];
// load src
// end load src
Fr_copy(aux_dest,&lvar[101]);
}
{
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[89],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[93],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[98],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[113],1);
// end call bucket
}
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[102],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[106],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[111],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[114],1);
// end call bucket
}
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[113]);
}
{
PFrElement aux_dest = &lvar[128];
// load src
// end load src
Fr_copy(aux_dest,&lvar[114]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[130]);
}
{
PFrElement aux_dest = &lvar[142];
// load src
// end load src
Fr_copy(aux_dest,&lvar[131]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[143]);
}
{
PFrElement aux_dest = &lvar[155];
// load src
// end load src
Fr_copy(aux_dest,&lvar[144]);
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&lvar[156]);
}
{
PFrElement aux_dest = &lvar[168];
// load src
// end load src
Fr_copy(aux_dest,&lvar[157]);
}
{
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[132],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[136],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[141],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[169],1);
// end call bucket
}
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[145],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[149],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[154],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[170],1);
// end call bucket
}
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[158],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[162],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[167],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[171],1);
// end call bucket
}
...
FrElement lvarcall[11];
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[34],4);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[4],&lvar[38],5);
// end copying argument 1
// copying argument 2
Fr_copyn(&lvarcall[9],&lvar[43],2);
// end copying argument 2
hA3Ked4lxIcti7O_0(ctx,lvarcall,myId,&lvar[195],1);
// end call bucket
}
...
// copying argument 0
Fr_copyn(&lvarcall[0],&lvar[176],15);
// end copying argument 0
// copying argument 1
Fr_copyn(&lvarcall[15],&lvar[191],4);
// end copying argument 1
ZySYRmHRP5ZTtmW_1(ctx,lvarcall,myId,&lvar[196],1);
// end call bucket
}

Fr_leq(&expaux[0],&circuitConstants[12],&signalValues[mySignalStart + 2]); // line circom 144
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
// load src
Fr_shl(&expaux[0],&lvar[195],&lvar[196]); // line circom 144
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
MWSjpAALvcBE_0_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_add(&expaux[3],&signalValues[mySignalStart + 2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 1]); // line circom 147
Fr_sub(&expaux[2],&expaux[3],&signalValues[mySignalStart + 4]); // line circom 147
Fr_sub(&expaux[1],&expaux[2],&circuitConstants[13]); // line circom 147
Fr_add(&expaux[0],&expaux[1],&circuitConstants[14]); // line circom 147
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[4],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 2],&signalValues[mySignalStart + 2]); // line circom 148
Fr_mul(&expaux[2],&circuitConstants[12],&expaux[4]); // line circom 148
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 2]); // line circom 148
Fr_add(&expaux[0],&expaux[1],&circuitConstants[39]); // line circom 148
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
O3h4P1AWedYt_1_create(1,0,ctx,"main",0);
O3h4P1AWedYt_1_run(0,ctx);
}
