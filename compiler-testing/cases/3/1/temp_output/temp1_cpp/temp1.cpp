...
uint get_size_of_constants() {return 39;}
...
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 1]); // line circom 147
Fr_sub(&expaux[0],&expaux[1],&signalValues[mySignalStart + 4]); // line circom 147
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 2],&signalValues[mySignalStart + 2]); // line circom 148
Fr_mul(&expaux[1],&circuitConstants[12],&expaux[3]); // line circom 148
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 148
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
