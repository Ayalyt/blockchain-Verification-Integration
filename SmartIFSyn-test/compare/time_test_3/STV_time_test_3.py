...
host_inout_path = os.path.join(host_project_path, "SmartIFSyn-test", "compare", "time_test_3", "inout")

subprocess.run('sudo pkill -f "docker exec.*python3.*STV_time_test_3"', shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
sys.exit(exit_code)
# STV average time: 600.371011018753
