...
host_inout_path = os.path.join(host_project_path, "SmartIFSyn-test", "compare", "time_test_4", "inout")

subprocess.run('sudo pkill -f "docker exec.*python3.*STV_time_test_4"', shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
sys.exit(exit_code)
# STV average time: 242.71051406860352
